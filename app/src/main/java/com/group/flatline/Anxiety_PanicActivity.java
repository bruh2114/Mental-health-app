...
public class Anxiety_PanicActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_anxiety_panic);
        ...
        new Handler(Looper.getMainLooper()).postDelayed(() -> {
            ...
            if (intro.equals("done")) {
                ...
                intent = new Intent(getApplicationContext(), AnxietyPanicStartingScreen.class);
            }
