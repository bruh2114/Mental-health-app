...
public class MentalHealthMythsActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_mental_health_myths);
        ...
        new Handler(Looper.getMainLooper()).postDelayed(() -> {
            ...
            if (intro.equals("done")) {
                ...
                intent = new Intent(getApplicationContext(), MentalHealthMythsStartingScreen.class);
            }
